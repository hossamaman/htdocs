...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo homepage_path; ?>/css/styles-merged.css">
    <link rel="stylesheet" href="<?php echo homepage_path; ?>/css/style.min.css">

    <!--[if lt IE 9]>
      <script src="<?php echo homepage_path; ?>/js/vendor/html5shiv.min.js"></script>
      <script src="<?php echo homepage_path; ?>/js/vendor/respond.min.js"></script>
    <![endif]-->
  </head>
  <body>
              ...
              <div class="probootstrap-home-showcase-inner">
                ...
                <div class="probootstrap-image-showcase">
                  <ul class="probootstrap-images-list">
                    <li class="active"><img src="<?php echo homepage_path; ?>/img/img_showcase_2.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo homepage_path; ?>/img/img_showcase_1.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo homepage_path; ?>/img/img_showcase_2.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo homepage_path; ?>/img/img_showcase_1.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo homepage_path; ?>/img/img_showcase_2.jpg" alt="Image" class="img-responsive"></li>
                    <li><img src="<?php echo homepage_path; ?>/img/img_showcase_1.jpg" alt="Image" class="img-responsive"></li>
                  </ul>
        ...
        <div class="row">
          <div class="col-md-7 col-md-push-5 probootstrap-animate"  data-animate-effect="fadeInRight">
            ...
            <div class="owl-carousel owl-carousel-fullwidth border-rounded">
              <div class="item">
                <img src="<?php echo homepage_path; ?>/img/img_showcase_1.jpg" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
              </div>
              <div class="item">
                <img src="<?php echo homepage_path; ?>/img/img_showcase_2.jpg" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
              </div>
              <div class="item">
                <img src="<?php echo homepage_path; ?>/img/img_showcase_1.jpg" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
              </div>
        ...
        <div class="row">
          <div class="col-md-4 probootstrap-animate" data-animate-effect="fadeIn">
            <div class="probootstrap-testimony-wrap text-center">
              <figure>
                <img src="<?php echo homepage_path; ?>/img/person_1.jpg" alt="Free Bootstrap Template by uicookies.com">
              </figure>
          ...
          <div class="col-md-4 probootstrap-animate" data-animate-effect="fadeIn">
            <div class="probootstrap-testimony-wrap text-center">
              <figure>
                <img src="<?php echo homepage_path; ?>/img/person_2.jpg" alt="Free Bootstrap Template by uicookies.com">
              </figure>
          ...
          <div class="col-md-4 probootstrap-animate" data-animate-effect="fadeIn">
            <div class="probootstrap-testimony-wrap text-center">
              <figure>
                <img src="<?php echo homepage_path; ?>/img/person_3.jpg" alt="Free Bootstrap Template by uicookies.com">
              </figure>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-6 text-center client-logo probootstrap-animate" data-animate-effect="fadeIn">
            <img src="<?php echo homepage_path; ?>/img/client_1.png" class="img-responsive" alt="Free Bootstrap Template by uicookies.com">
          </div>
          <div class="col-md-3 col-sm-6 col-xs-6 text-center client-logo probootstrap-animate" data-animate-effect="fadeIn">
            <img src="<?php echo homepage_path; ?>/img/client_2.png" class="img-responsive" alt="Free Bootstrap Template by uicookies.com">
          </div>
          <div class="clearfix visible-sm-block visible-xs-block"></div>
          <div class="col-md-3 col-sm-6 col-xs-6 text-center client-logo probootstrap-animate" data-animate-effect="fadeIn">
            <img src="<?php echo homepage_path; ?>/img/client_3.png" class="img-responsive" alt="Free Bootstrap Template by uicookies.com">
          </div>
          <div class="col-md-3 col-sm-6 col-xs-6 text-center client-logo probootstrap-animate" data-animate-effect="fadeIn">
            <img src="<?php echo homepage_path; ?>/img/client_4.png" class="img-responsive" alt="Free Bootstrap Template by uicookies.com">
          </div>
    ...
    <script src="<?php echo homepage_path; ?>/js/scripts.min.js"></script>
    <script src="<?php echo homepage_path; ?>/js/custom.min.js"></script>
  </body>
</html>

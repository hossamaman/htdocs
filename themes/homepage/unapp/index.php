...
<html>
	...
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="<?php echo homepage_path; ?>/css/icomoon.css">
	<!-- Bootstrap  -->
	...
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="<?php echo homepage_path; ?>/css/owl.carousel.min.css">
	<link rel="stylesheet" href="<?php echo homepage_path; ?>/css/owl.theme.default.min.css">

	<!-- Theme style  -->
	<link rel="stylesheet" href="<?php echo homepage_path; ?>/css/style.css">

	<!-- Modernizr JS -->
	<script src="<?php echo homepage_path; ?>/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	<script src="<?php echo homepage_path; ?>/js/respond.min.js"></script>
	<![endif]-->
	...
	<div id="page">
		...
		<section id="home" class="video-hero" style="height: 700px; background-image: url(<?php echo homepage_path; ?>/images/cover_img_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
						...
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="<?php echo homepage_path; ?>/images/dashboard_full_1.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="<?php echo homepage_path; ?>/images/dashboard_full_2.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="<?php echo homepage_path; ?>/images/dashboard_full_3.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row mobile-wrap">
					<div class="col-md-5 animate-box">
						<div class="mobile-img" style="background-image: url(<?php echo homepage_path; ?>/images/mobile-2.jpg);"></div>
					</div>
				...
				<div class="row mobile-wrap">
					<div class="col-md-5 col-md-push-7 animate-box">
						<div class="mobile-img" style="background-image: url(<?php echo homepage_path; ?>/images/mobile-1.jpg);"></div>
					</div>
		...
		<div id="colorlib-counter" class="colorlib-counters" style="background-image: url(<?php echo homepage_path; ?>/images/cover_img_1.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-4 animate-box">
						<article>
							...
							<p class="author-wrap"><a href="#" class="author-img" style="background-image: url(<?php echo homepage_path; ?>/images/person1.jpg);"></a> <a href="#" class="author">by Dave Miller</a></p>
						</article>
					</div>
					<div class="col-md-4 animate-box">
						<article>
							...
							<p class="admin"><span>May 12, 2018</span></p>
							<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
							<p class="author-wrap"><a href="#" class="author-img" style="background-image: url(<?php echo homepage_path; ?>/images/person2.jpg);"></a> <a href="#" class="author">by Dave Miller</a></p>
						</article>
					</div>
					<div class="col-md-4 animate-box">
						<article>
							...
							<p class="admin"><span>May 12, 2018</span></p>
							<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
							<p class="author-wrap"><a href="#" class="author-img" style="background-image: url(<?php echo homepage_path; ?>/images/person3.jpg);"></a> <a href="#" class="author">by Dave Miller</a></p>
						</article>
					</div>
				</div>
			</div>
		...
		<div id="colorlib-subscribe" class="colorlib-subscribe" style="background-image: url(<?php echo homepage_path; ?>/images/cover_img_1.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row row-pb-md">
					...
					<div class="col-md-3 colorlib-widget">
						<h4>Recent Blog</h4>
						<div class="f-blog">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo homepage_path; ?>/images/blog-1.jpg);">
							</a>
							<div class="desc">
						...
						<div class="f-blog">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo homepage_path; ?>/images/blog-2.jpg);">
							</a>
							<div class="desc">
						...
						<div class="f-blog">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo homepage_path; ?>/images/blog-3.jpg);">
							</a>
							<div class="desc">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --><br>
	...
	<!-- jQuery -->
	<script src="<?php echo homepage_path; ?>/js/jquery.min.js"></script>
	<!-- jQuery Easing -->
	<script src="<?php echo homepage_path; ?>/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="<?php echo homepage_path; ?>/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="<?php echo homepage_path; ?>/js/jquery.waypoints.min.js"></script>
	<!-- Stellar Parallax -->
	<script src="<?php echo homepage_path; ?>/js/jquery.stellar.min.js"></script>
	<!-- YTPlayer -->
	<script src="<?php echo homepage_path; ?>/js/jquery.mb.YTPlayer.min.js"></script>
	<!-- Owl carousel -->
	...
	<script src="<?php echo homepage_path; ?>/js/magnific-popup-options.js"></script>
	<!-- Counters -->
	<script src="<?php echo homepage_path; ?>/js/jquery.countTo.js"></script>
	<!-- Main -->

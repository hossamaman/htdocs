...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
		...
		<!-- jquery.fancybox  -->
        <link rel="stylesheet" href="<?php echo homepage_path; ?>/css/jquery.fancybox.css">
		<!-- animate -->
		...
		<!-- media-queries -->
        <link rel="stylesheet" href="<?php echo homepage_path; ?>/css/media-queries.css">
    ...
    <body id="body">
		...
		<!-- preloader -->
		<div id="preloader">
			<img src="<?php echo homepage_path; ?>/img/preloader.gif" alt="Preloader">
		</div>
		<!-- end preloader -->
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#body">
						<h1 id="logo">
							<img src="<?php echo homepage_path; ?>/img/logo.png" alt="Brandi">
						</h1>
					</a>
					<!-- /logo -->
                </div>
		...
		<section id="slider">
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					...
					<!-- single slide -->
					<div class="item active" style="background-image: url(<?php echo homepage_path; ?>/img/banner.jpg);">
					...
					<!-- single slide -->
					<div class="item" style="background-image: url(<?php echo homepage_path; ?>/img/banner.jpg);">
						<div class="carousel-caption">
		...
		<section id="works" class="works clearfix">
			...
			<div class="project-wrapper">
				...
				<figure class="mix work-item branding">
					<img src="<?php echo homepage_path; ?>/img/works/item-1.jpg" alt="">
				...
				<figure class="mix work-item web">
					<img src="<?php echo homepage_path; ?>/img/works/item-2.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item logo-design">
					<img src="<?php echo homepage_path; ?>/img/works/item-3.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item photography">
					<img src="<?php echo homepage_path; ?>/img/works/item-4.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item branding">
					<img src="<?php echo homepage_path; ?>/img/works/item-5.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item web">
					<img src="<?php echo homepage_path; ?>/img/works/item-6.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item logo-design">
					<img src="<?php echo homepage_path; ?>/img/works/item-7.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item photography">
					<img src="<?php echo homepage_path; ?>/img/works/item-8.jpg" alt="">
					<figcaption class="overlay">
				...
				<div class="row">
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms">
						<div class="member-thumb">
							<img src="<?php echo homepage_path; ?>/img/team/member-1.png" alt="Team Member" class="img-responsive">
							<figcaption class="overlay">
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="300ms">
						<div class="member-thumb">
							<img src="<?php echo homepage_path; ?>/img/team/member-2.png" alt="Team Member" class="img-responsive">
							<figcaption class="overlay">
								<h5>voluptatem quia voluptas </h5>
								<p>sit aspernatur aut odit aut fugit,</p>
								<ul class="social-links text-center">
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="600ms">
						<div class="member-thumb">
							<img src="<?php echo homepage_path; ?>/img/team/member-3.png" alt="Team Member" class="img-responsive">
							<figcaption class="overlay">
								<h5>voluptatem quia voluptas </h5>
								<p>sit aspernatur aut odit aut fugit,</p>
								<ul class="social-links text-center">
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-duration="500ms">
						<div class="footer-single">
							<img src="<?php echo homepage_path; ?>/img/footer-logo.png" alt="">
		...
		================================================== -->
		<!-- Main jQuery -->
        <script src="<?php echo homepage_path; ?>/js/jquery-1.11.1.min.js"></script>
		<!-- Single Page Nav -->
        <script src="<?php echo homepage_path; ?>/js/jquery.singlePageNav.min.js"></script>
		<!-- Twitter Bootstrap -->
        <script src="<?php echo homepage_path; ?>/js/bootstrap.min.js"></script>
		<!-- jquery.fancybox.pack -->
        <script src="<?php echo homepage_path; ?>/js/jquery.fancybox.pack.js"></script>
		<!-- jquery.mixitup.min -->
        <script src="<?php echo homepage_path; ?>/js/jquery.mixitup.min.js"></script>
		<!-- jquery.parallax -->
        <script src="<?php echo homepage_path; ?>/js/jquery.parallax-1.1.3.js"></script>
		<!-- jquery.countTo -->
        <script src="<?php echo homepage_path; ?>/js/jquery-countTo.js"></script>
		<!-- jquery.appear -->
        <script src="<?php echo homepage_path; ?>/js/jquery.appear.js"></script>
		...
		<!-- jquery easing -->
        <script src="<?php echo homepage_path; ?>/js/jquery.easing.min.js"></script>
		<!-- jquery easing -->
        <script src="<?php echo homepage_path; ?>/js/wow.min.js"></script>
		<script>
			var wow = new WOW ({
		...
		<!-- Custom Functions -->
        <script src="<?php echo homepage_path; ?>/js/custom.js"></script>

...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        <a class="navbar-brand" href="index.html"><img src="<?php echo homepage_path; ?>/images/logo.png" class="img-fluid" alt="logo"></a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
    ...
    <header class="bg-gradient" id="home">
        ...
        <div class="img-holder mt-3"><img src="<?php echo homepage_path; ?>/images/iphonex.png" alt="phone" class="img-fluid"></div>
    </header>

    <div class="client-logos my-5">
        <div class="container text-center">
            <img src="<?php echo homepage_path; ?>/images/client-logos.png" alt="client logos" class="img-fluid">
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="perspective-phone">
                <img src="<?php echo homepage_path; ?>/images/perspective.png" alt="perspective phone" class="img-fluid">
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        <img src="<?php echo homepage_path; ?>/images/graphic.png" alt="graphic" class="img-fluid rounded align-self-start mr-lg-5 mb-5 mb-lg-0">
                        <div>
    ...
    <div class="section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="<?php echo homepage_path; ?>/images/dualphone.png" alt="dual phone" class="img-fluid">
                </div>
    ...
    <div class="section light-bg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="<?php echo homepage_path; ?>/images/iphonex.png" alt="iphone" class="img-fluid">
                </div>
        ...
        <div class="container">
            ...
            <div class="testimonials owl-carousel">
                <div class="testimonials-single">
                    <img src="<?php echo homepage_path; ?>/images/client.png" alt="client" class="client-img">
    ...
    <div class="section light-bg" id="gallery">
        <div class="container">
            ...
            <div class="img-gallery owl-carousel owl-theme">
                <img src="<?php echo homepage_path; ?>/images/screen1.jpg" alt="image">
                <img src="<?php echo homepage_path; ?>/images/screen2.jpg" alt="image">
                <img src="<?php echo homepage_path; ?>/images/screen3.jpg" alt="image">
                <img src="<?php echo homepage_path; ?>/images/screen1.jpg" alt="image">
            </div>
        ...
        <div class="container">
            <div class="call-to-action">
                ...
                <div class="my-4">
                    ...
                    <a href="#" class="btn btn-light"><img src="<?php echo homepage_path; ?>/images/appleicon.png" alt="icon"> App Store</a>
                    <a href="#" class="btn btn-light"><img src="<?php echo homepage_path; ?>/images/playicon.png" alt="icon"> Google play</a>
                </div>
    ...
    <script src="<?php echo homepage_path; ?>/js/bootstrap.bundle.min.js"></script>
    <!-- Plugins JS -->
    <script src="<?php echo homepage_path; ?>/js/owl.carousel.min.js"></script>
    <!-- Custom JS -->
    <script src="<?php echo homepage_path; ?>/js/script.js"></script>

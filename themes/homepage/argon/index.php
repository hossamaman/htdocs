...
<head>
  ...
  <title>Argon</title>
  <!-- Favicon -->
  <link href="<?php echo homepage_path; ?>/assets/img/brand/favicon.png" rel="icon" type="image/png">
  <!-- Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
  <!-- Icons -->
  <link href="<?php echo homepage_path; ?>/assets/vendor/nucleo/css/nucleo.css" rel="stylesheet">
  <link href="<?php echo homepage_path; ?>/assets/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <!-- Argon CSS -->
  <link type="text/css" href="<?php echo homepage_path; ?>/assets/css/argon.css?v=1.0.1" rel="stylesheet">
  <!-- Docs CSS -->
  <link type="text/css" href="<?php echo homepage_path; ?>/assets/css/docs.min.css" rel="stylesheet">
</head>
...
<body>
    ...
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
      <div class="container">
        <a class="navbar-brand mr-lg-5" href="./index.html">
          <img src="<?php echo homepage_path; ?>/assets/img/brand/white.png">
        </a>
          ...
          <div class="navbar-collapse-header">
            <div class="row">
              <div class="col-6 collapse-brand">
                <a href="./index.html">
                  <img src="<?php echo homepage_path; ?>/assets/img/brand/blue.png">
                </a>
              </div>
          ...
          <div class="col px-0">
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-6 text-center">
                <img src="<?php echo homepage_path; ?>/assets/img/brand/white.png" style="width: 200px;" class="img-fluid">
                ...
                <div class="mt-5">
                  ...
                  <img src="<?php echo homepage_path; ?>/assets/img/brand/creativetim-white-slim.png" style="height: 28px;">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-3 col-6">
            ...
            <img src="<?php echo homepage_path; ?>/assets/img/theme/team-1-800x800.jpg" alt="Rounded image" class="img-fluid rounded shadow" style="width: 150px;">
          </div>
          <div class="col-sm-3 col-6">
            <small class="d-block text-uppercase font-weight-bold mb-4">Circle Image</small>
            <img src="<?php echo homepage_path; ?>/assets/img/theme/team-2-800x800.jpg" alt="Circle image" class="img-fluid rounded-circle shadow" style="width: 150px;">
          </div>
          <div class="col-sm-3 col-6 mt-5 mt-sm-0">
            <small class="d-block text-uppercase font-weight-bold mb-4">Raised</small>
            <img src="<?php echo homepage_path; ?>/assets/img/theme/team-3-800x800.jpg" alt="Raised image" class="img-fluid rounded shadow-lg" style="width: 150px;">
          </div>
          <div class="col-sm-3 col-6 mt-5 mt-sm-0">
            <small class="d-block text-uppercase font-weight-bold mb-4">Circle Raised</small>
            <img src="<?php echo homepage_path; ?>/assets/img/theme/team-4-800x800.jpg" alt="Raised circle image" class="img-fluid rounded-circle shadow-lg" style="width: 150px;">
          </div>
        </div>
        <h2 class="mt-lg mb-5">
                      ...
                      <div class="card-header bg-white pb-5">
                        ...
                        <div class="btn-wrapper text-center">
                          <a href="#" class="btn btn-neutral btn-icon">
                            <span class="btn-inner--icon">
                              <img src="<?php echo homepage_path; ?>/assets/img/icons/common/github.svg">
                            </span>
                            <span class="btn-inner--text">Github</span>
                          </a>
                          <a href="#" class="btn btn-neutral btn-icon">
                            <span class="btn-inner--icon">
                              <img src="<?php echo homepage_path; ?>/assets/img/icons/common/google.svg">
                            </span>
              ...
              <div id="carousel_example" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="img-fluid" src="<?php echo homepage_path; ?>/assets/img/theme/img-1-1200x1000.jpg" alt="First slide">
                  </div>
                  <div class="carousel-item">
                    <img class="img-fluid" src="<?php echo homepage_path; ?>/assets/img/theme/img-2-1200x1000.jpg" alt="Second slide">
                  </div>
                </div>
        ...
        <div class="col-md-6 mb-5 mb-md-0">
          <div class="card card-lift--hover shadow border-0">
            <a href="./examples/landing.html" title="Landing Page">
              <img src="<?php echo homepage_path; ?>/assets/img/theme/landing.jpg" class="card-img">
            </a>
          </div>
        </div>
        <div class="col-md-6 mb-5 mb-lg-0">
          <div class="card card-lift--hover shadow border-0">
            <a href="./examples/profile.html" title="Profile Page">
              <img src="<?php echo homepage_path; ?>/assets/img/theme/profile.jpg" class="card-img">
            </a>
          </div>
        </div>
      </div>
  ...
  <!-- Core -->
  <script src="<?php echo homepage_path; ?>/assets/vendor/jquery/jquery.min.js"></script>
  <script src="<?php echo homepage_path; ?>/assets/vendor/popper/popper.min.js"></script>
  <script src="<?php echo homepage_path; ?>/assets/vendor/bootstrap/bootstrap.min.js"></script>
  <script src="<?php echo homepage_path; ?>/assets/vendor/headroom/headroom.min.js"></script>
  <!-- Optional JS -->
  <script src="<?php echo homepage_path; ?>/assets/vendor/onscreen/onscreen.min.js"></script>
  <script src="<?php echo homepage_path; ?>/assets/vendor/nouislider/js/nouislider.min.js"></script>
  <script src="<?php echo homepage_path; ?>/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
  <!-- Argon JS -->
  <script src="<?php echo homepage_path; ?>/assets/js/argon.js?v=1.0.1"></script>
</body>
